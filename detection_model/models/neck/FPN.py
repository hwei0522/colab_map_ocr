...
from detection_model.models.basic import ConvBnRelu
#from .ASF import ScaleFeatureSelection ## DBnet++
...
class FPN(nn.Module):
    def __init__(self, in_channels, inner_channels=256, **kwargs):
        ...
        #self.concat_attention = ScaleFeatureSelection(inner_channels*4, inner_channels, ) ## DBnet++
    ...
    def forward(self, x):
        ...
        #x = self.concat_attention(x, [p5, p4, p3, p2]) ## DBnet++
        x = self.conv(x)
        return x
